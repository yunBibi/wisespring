...
<div id="tabs">
	...
	<div id="convert">
		...
		<div id="convert-bean">
			...
			<ul>
				...
				<li>
					<a id="listProp" class="textLink" href="<c:url value="/convert/bean?list%5b0%5d=1&list%5b1%5d=2&list%5b2%5d=3" />">List Elements</a>
					<%-- <a id="listProp" class="textLink" href="<c:url value="/convert/bean?list[0]=1&list[1]=2&list[2]=3" />">List Elements</a> --%>					
				</li>
				<li>
					<a id="formattedListProp" class="textLink" href="<c:url value="/convert/bean?formattedList%5b0%5d=2010-07-04&formattedList%5b1%5d=2011-07-04" />">@Formatted List Elements</a>
				...
				<li>
					<a id="mapProp" class="textLink" href="<c:url value="/convert/bean?map%5b0%5d=apple&map%5b1%5d=pear" />">Map Elements</a>
					<%-- <a id="mapProp" class="textLink" href="<c:url value="/convert/bean?map[0]=apple&map[1]=pear" />">Map Elements</a> --%>
				</li>
				<li>
					<a id="nestedProp" class="textLink" href="<c:url value="/convert/bean?nested.foo=bar&nested.list%5b0%5d.foo=baz&nested.map%5bkey%5d.list%5b0%5d.foo=bip" />">Nested</a>
	...
	<div id="validation">
		...
		<ul>
			<li>
				<a id="validateNoErrors" class="textLink" href="<c:url value="/validate?number=1&date=2029-07-04" />">Validate, no errors</a>
			</li>
			<li>
